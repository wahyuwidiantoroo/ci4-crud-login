    ...
    <form action="/books/update/<?= $books['id']; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control <?php echo (isset($validation['judul'])) ? 'is-invalid' : ''; ?>" id="judulbuku" placeholder="Judul Buku" name="judul" autofocus value="<?= (old('judul')) ? old('judul') : $books['judul']; ?>">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control <?php echo (isset($validation['penulis'])) ? 'is-invalid' : ''; ?>" id="penulis" placeholder="Penulis" name="penulis" value="<?= (old('penulis')) ? old('penulis') : $books['penulis']; ?>">
                <div id=" validationServerUsernameFeedback" class="invalid-feedback">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="penerbit" placeholder="Penerbit" name="penerbit" value="<?= (old('penerbit')) ? old('penerbit') : $books['penerbit']; ?>">
            </div>
            <div class="form-group col-md-6">
